                    ...
                    <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            <div class="mb-4 col-md-6">
                                ...
                                <input value="{{$job->salery}}" type="text" placeholder="Salary" id="salary" name="salary" class="form-control">
                            </div>
                        ...
                        <div class="mb-4 col-md-6">
                         <div class="form-check">
                            <input {{($job->isFeatured == 1) ? 'checked' : ''}} type="checkbox" class="form-check-input" value="1" name="isFeatured" id="isFeatured">
                        ...
                        <div class="mb-4 col-md-6">
                            <div class="form-check-inline">
                               <input {{($job->status == 1) ? 'checked' : ''}} type="radio"  value="1" name="status" id="status-active">
                               <label for="status-active" class="form-check-label">
                                   Active
                               </label>
                            ...
                            <div class="form-check-inline">
                                <input {{($job->status == 0) ? 'checked' : ''}} type="radio"  value="0" name="status" id="status-deactive">
                                <label for="status-deactive" class="form-check-label">
                                    Deactive
                                </label>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control summernote" name="responsibility" id="responsibility" cols="5" rows="5" placeholder="Responsibility">{{$job->responsibility}}</textarea>
                        </div>
                        <div class="mb-4">
                            <label for="" class="mb-2">Qualifications</label>
                            <textarea class="form-control summernote" name="qualifications" id="qualifications" cols="5" rows="5" placeholder="Qualifications">{{$job->qualification}}</textarea>
                        </div>
        ...
        if(response.status == true) {
          ...
          $("#company_name").removeClass("is-invalid").siblings("p").removeClass("invalid-feedback").html("");
            ...
            if(response.errors['title']) {
             $("#title").addClass("is-invalid").siblings("p").addClass("invalid-feedback").html(response.errors['title']);
            }else{
                $("#title").removeClass("is-invalid").siblings("p").removeClass("invalid-feedback").html("");
            ...
            if(response.errors['category']) {
             $("#category").addClass("is-invalid").siblings("p").addClass("invalid-feedback").html(response.errors['category']);
            }else{
             $("#category").removeClass("is-invalid").siblings("p").removeClass("invalid-feedback").html("");
            ...
            if(response.errors['jobType']) {
             $("#jobType").addClass("is-invalid").siblings("p").addClass("invalid-feedback").html(response.errors['jobType']);
            }else{
             $("#jobType").removeClass("is-invalid").siblings("p").removeClass("invalid-feedback").html("");
            ...
            if(response.errors['vacancy']) {
             $("#vacancy").addClass("is-invalid").siblings("p").addClass("invalid-feedback").html(response.errors['vacancy']);
            }else{
             $("#vacancy").removeClass("is-invalid").siblings("p").removeClass("invalid-feedback").html("");
            ...
            if(response.errors['location']) {
             $("#location").addClass("is-invalid").siblings("p").addClass("invalid-feedback").html(response.errors['location']);
            }else{
             $("#location").removeClass("is-invalid").siblings("p").removeClass("invalid-feedback").html("");
            ...
            if(response.errors['description']) {
             $("#description").addClass("is-invalid").siblings("p").addClass("invalid-feedback").html(response.errors['description']);
            }else{
             $("#description").removeClass("is-invalid").siblings("p").removeClass("invalid-feedback").html("");
            ...
            if(response.errors['company_name']) {
             $("#company_name").addClass("is-invalid").siblings("p").addClass("invalid-feedback").html(response.errors['company_name']);
            }else{
             $("#company_name").removeClass("is-invalid").siblings("p").removeClass("invalid-feedback").html("");
