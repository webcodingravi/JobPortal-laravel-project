          ...
          <div class="col-md-4 col-lg-3 sidebar mb-4">
            <form action="" name="searchForm" id="searchForm">
              <div class="card border-0 shadow p-4">
                  ...
                  <a href="{{route("front.jobs")}}" class="btn btn-primary mt-3">Reset</a>
                        ...
                        <div class="card border-0 p-3 shadow mb-4">
                            <div class="card-body">
                                ...
                                <div class="bg-light p-3 border">
                                    ...
                                    @if(!is_null($job->salery))
                                    <p class="mb-0">
                                        <span class="fw-bolder"><i class="fa fa-usd"></i></span>
                                        <span class="ps-1">{{$job->salery}}</span>
                                    </p>
                                    @endif
                                </div>

                                <div class="d-grid mt-3">
                                    <a href="{{route('front.jobDetail',$job->id)}}" class="btn btn-primary btn-lg">Details</a>
                                </div>
                            </div>
                        </div>
                    </div> 
...
// If location has a value
  ...
  $("input:checkbox[name='job_type']").change(function() {
    $("#searchForm").submit();
  });
