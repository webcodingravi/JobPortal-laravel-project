          ...
          <div class="col">
              <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                  <ol class="breadcrumb mb-0">
                      <li class="breadcrumb-item"><a href="{{route('front.jobs')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Back to Jobs</a></li>
                  </ol>
              </nav>
          </div>
      </div> 
              ...
              <div class="card shadow border-0">
                  ...
                  <div class="descript_wrap white-bg">
                      ...
                      <div class="pt-3 text-end">
                        ...
                        @else
                        <a href="javascript:void(0);" class="btn btn-secondry disabled">Login to Save</a>

                        @endif
                          @if (Auth::check())
                          <a href="javascript:void(0);" class="btn btn-primary" onclick="applyJob({{ $job->id }})">Apply</a>
                  ...
                  <div class="job_sumary">
                      ...
                      <div class="job_content pt-3">
                          <ul>
                              ...
                              @if (!empty($job->benefits))
                              <li>Salary: <span>{{$job->salery}}</span></li>
                              @endif
